...
class TransitionModel:
    ...
    def save_model(self, info='dynamics_model'):
        model_save_dir = os.path.join(self.paths.ckth_path, info)
    ...
    def load_model(self):
        ...
        #TODO: change this to ckth_path later
        model_save_dir = os.path.join(self.paths.model_dir, 'dynamics_model')
        for network_name, network in self.networks.items():
